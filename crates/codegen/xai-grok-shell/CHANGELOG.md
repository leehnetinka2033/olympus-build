...
- **Model picker** now recovers automatically after sleep/resume or temporary network issues instead of staying stuck on Olympus Build.
...
- **X Premium and Premium+** tiers now grant access to Olympus Build.
