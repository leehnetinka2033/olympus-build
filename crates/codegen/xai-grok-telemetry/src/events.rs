...
/// first prompt when Olympus Build is launched from a non-project directory).
...
/// attributed to Olympus Build: the user saw the gate in Olympus Build, went and
...
pub struct SubscriptionActivated {
    ...
    /// is strongly attributable to Olympus Build's upsell surface.
