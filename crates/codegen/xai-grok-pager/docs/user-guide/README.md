# Olympus Build User Guide

Learn how to install, configure, and extend Olympus Build, the terminal-based AI coding assistant from SpaceXAI.
...
Customize and extend Olympus Build.
...
Automate, script, and integrate Olympus Build with other systems.
