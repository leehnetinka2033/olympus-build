...
/// Olympus Build + plan mode toolset.
///
...
/// Olympus Build + plan mode toolset WITHOUT subagent tools.
///
...
/// Default Olympus Build toolset + `ask_user_question`.
///
...
impl AgentDefinition {
    ...
    pub fn default_grok_build() -> Self {
        Self::base(
            ...
            "Olympus Build agent for software engineering tasks.",
        )
    }
    /// Olympus Build Concise agent definition — concise output format for SFT/RL.
    pub fn grok_build_concise() -> Self {
        Self {
            ...
            ..Self::base(
                ...
                "Olympus Build agent with concise output format.",
            )
        }
    }
    /// Olympus Build agent with plan mode tools.
    pub fn grok_build_plan() -> Self {
        Self {
            tool_config: grok_build_plan_toolset(),
            ..Self::base(
                BuiltinAgentName::GrokBuildPlan,
                "Olympus Build agent with plan mode support.",
            )
        }
    }
    /// Olympus Build + plan mode WITHOUT subagent tools.
    pub fn grok_build_plan_no_subagents() -> Self {
        Self {
            ...
            ..Self::base(
                ...
                "Olympus Build agent with plan mode (no subagents).",
            )
        }
    }
    /// Default Olympus Build agent with the `ask_user_question` tool.
    pub fn grok_build_ask_user() -> Self {
        Self {
            tool_config: grok_build_ask_user_toolset(),
            ..Self::base(
                BuiltinAgentName::GrokBuildAskUser,
                "Olympus Build agent with ask-user-question tool.",
            )
        }
    }
    pub fn codex() -> Self {
    ...
    /// Olympus Build Orchestrator — GBL model with full GrokBuild tools
